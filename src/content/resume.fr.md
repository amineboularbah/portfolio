...
Málaga, Espagne · [amine@amineboularbah.com](mailto:amine@amineboularbah.com)
...
Ingénieur mobile senior avec plus de 6 ans d’expérience dans la conception d’applications mobiles performantes et évolutives. Je dirige actuellement une équipe de 5 ingénieurs chargée de la refonte de l’application de football 433, destinée à plus de 77 millions de fans. Je pilote sa conception en Clean Architecture, la mise en place d’un monorepo modulaire et l’automatisation CI/CD. Expertise approfondie de Flutter, Dart et de la gestion d’état avec BLoC. Je conçois et commercialise également mes propres produits de bout en bout, avec une attention particulière à la fiabilité, aux besoins des utilisateurs et à la capacité de montée en charge.
...
- Encadrement d’une équipe pluridisciplinaire à distance et mise en place de conventions de code, de règles d’architecture et de pratiques de test
- Mise en place de pipelines CI/CD automatisés, réduisant le temps de déploiement de 30 % et améliorant la fiabilité des livraisons
- Conception et maintenance de services backend avec NestJS, reliant les clients mobiles et web aux systèmes de paiement et à la blockchain
- Rédaction de documentation interne sur les tests, l’architecture et les revues de code, réduisant le temps d’intégration des nouveaux ingénieurs

### Ingénieur mobile full stack chez Flow Digital Studio

Rabat · Mai 2021 à novembre 2021

- Développement d’applications web et mobiles avec Flutter et NestJS pour des clients de plusieurs secteurs
- Création de composants d’interface adaptatifs et réutilisables pour assurer un comportement cohérent sur chaque plateforme
- Conception et utilisation d’API REST et intégration de services tiers pour enrichir les fonctionnalités des applications

### Ingénieur mobile chez MEGALOGI

Rabat · Septembre 2020 à mai 2021

- Pilotage du développement de MyButcher sur Android et iOS avec Flutter, intégrant Firebase et les API Shopify, avec une hausse de la rétention des utilisateurs de 15 %
- Amélioration de la lecture audio et vidéo dans iSophro, avec une hausse de l’engagement de 10 %
...
### Certificat professionnel de développeur iOS, Meta
...
- Git/GitFlow
- Codemagic
- Tests unitaires, d’intégration et d’interface
...
Rencontres techniques, fitness, photographie
